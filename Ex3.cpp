...
const int& fun3e(int &x) {
	return x;
}
const int&& fun3f(int x) {
	return std::move(x + 3);
}
...
const int* fun3B(int *x) {
	return x;
}
int* const fun3C(int *x) {
	return x;
}
const int* const fun3D(int *x) {
	return x;
}
...
//		int &b6 = fun3f(a);
	...
	{
		int &&b1 = fun3a(a);
//		int &&b2 = fun3b(a); // rvalue vers int
		int &&b3 = fun3c(a);
		int &&b4 = fun3d();
//		int &&b5 = fun3e(a); // rvalue vers const int
//		int &&b6 = fun3f(a); // idem
	}
	...
	{
		const int &&b1 = fun3a(a);
//		const int &&b2 = fun3b(a); // rvalue vers int
		const int &&b3 = fun3c(a);
		const int &&b4 = fun3d();
//		const int &&b5 = fun3e(a); // rvalue vers const int
		const int &&b6 = fun3f(a);
	}

	{
		int *b1 = fun3A(&a);
//		int *b2 = fun3B(&a); // const int* vers int* Impossible.
		int *b3 = fun3C(&a);
//		int *b4 = fun3D(&a); // const int* vers int*
	}
